...
describe('useDefaultHomePagePath', () => {
  ...
  // the home redirect respects the last-visited object instead of always
  // falling back to the alphabetically-first one.
  it('should redirect to last-visited object when currentUser is defined', async () => {
