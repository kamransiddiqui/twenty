...
describe('useDefaultHomePagePath', () => {
  ...
  // localStorage on init so the redirect respects the last-visited object
  // instead of always falling back to the alphabetically-first one.
  it('should redirect to the last-visited object when one is persisted', async () => {
